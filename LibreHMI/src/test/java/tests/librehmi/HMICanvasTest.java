...
import andrade.luis.librehmi.views.canvas.CanvasText;
...
class HMICanvasTest {
    ...
    void addGraphicalRepresentationTest(FxRobot robot) {
        ...
        Assertions.assertThat(root.getShapeArrayList()).isNotEmpty();
    ...
    void addMultipleGraphicalRepresentation(FxRobot robot) {
        ...
        Assertions.assertThat(root.getShapeArrayList()).isNotEmpty();
        Assertions.assertThat(root.getShapeArrayList()).hasSize(5);
    }

    CanvasObject getAddedGraphicalRepresentation(){
        CanvasObject rectangle = null;
        for (int i = 0; i < root.getChildren().size(); i++) {
            if (root.getChildren().get(i).getId() != null) {
                if (root.getChildren().get(i).getId().equals("#createdShape0")) {
                    rectangle = (CanvasObject) root.getChildren().get(i);
                }
            }
        }
        return rectangle;
    ...
    void moveGraphicalRepresentation(FxRobot robot) {
        addGraphicalRepresentationSequence(robot);
        CanvasObject rectangle = getAddedGraphicalRepresentation();
        ...
        rectangle = getAddedGraphicalRepresentation();
    ...
    CanvasObject reduceMenuItemsInGraphicalRepresentation(CanvasObject rectangle, String id){
    ...
    void rightClickOnRightClickMenu(FxRobot robot, CanvasObject rectangle){
    ...
    void copyGraphicalRepresentationToClipboardByRightClickOnContextMenuAndPasteOnKeyCombination(FxRobot robot) {
        ...
        Assertions.assertThat(root.getShapeArrayList()).hasSize(2);
    }
    ...
    String copyGraphicalRepresentationToClipboardByKeyCombination(FxRobot robot) {
        ...
        return getAddedGraphicalRepresentation().getId();
    }
    ...
    String cutGraphicalRepresentationToClipboardByKeyCombination(FxRobot robot) {
        ...
        String oldId = getAddedGraphicalRepresentation().getId();
    ...
    void cutGraphicalRepresentationToClipboardByKeyCombinationAndPasteOnRightClick(FxRobot robot) {
        ...
        Assertions.assertThat(root.getShapeArrayList()).hasSize(1);
    }
    ...
    void deleteGraphicalRepresentationByRightClickOnContextMenuTest(FxRobot robot){
        ...
        Assertions.assertThat(root.getShapeArrayList()).isEmpty();
    ...
    void addSystemDateTimeLabel(FxRobot robot){
        ...
        CanvasObject canvasSystemDateTimeLabel = getAddedGraphicalRepresentation();
    ...
    void addTextLabel(FxRobot robot){
        ...
        CanvasText canvasSystemDateTimeLabel = (CanvasText) getAddedGraphicalRepresentation();
        Assertions.assertThat(canvasSystemDateTimeLabel).isNotNull();
